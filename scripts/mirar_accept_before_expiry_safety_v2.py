"""
MIRAR el tablero de seguridad de ACCEPT_BEFORE_EXPIRY contra la foto de ahora.

ESTO NO ES UNA GUARDIA (19/09/2026)

    Nacio como `test_accept_before_expiry_safety_v2.py` en `src/analysis/` y lee
...
USO
    ...
    python scripts/mirar_accept_before_expiry_safety_v2.py
