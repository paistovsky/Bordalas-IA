    ...
    try:
        ...
        for player_id, venta in a_mirar:
            ...
            if fila["counter_offer"]:
                ...
                # LA LISTA DE LA NOCHE YA NO SE ARMA AQUI (25/09/2026)
                #
                #     Aqui se reconstruia la decision con la moneda
                #     puesta: otra via, el bolsillo de la de hoy. El
                #     25/09 enseñaba 3.674.989 por Lejeune cuando la
                #     decision real era SUPERA_PRESUPUESTO. La lista
                #     ahora lee la decision de este tablero tal cual:
                #     ver `la_lista_de_la_noche`.
