...
function decisionPortrait(data) {
  ...
  if (level === "ACTION" || pressure >= 75 || hours <= 2) {
    return ["critical", "/assets/bordalas-critical.jpg"];
  }
  if (level === "SOLVENCY" || pressure >= 50 || hours <= 6) {
    return ["alert", "/assets/bordalas-alert.jpg"];
  }
  if (level === "WAIT" || pressure >= 20) {
    return ["watch", "/assets/bordalas-watch.jpg"];
  }
  return ["calm", "/assets/bordalas-calm.jpg"];
}
