...
function createSlottable(ownerName) {
  const Slottable22 = __name4((props) => "child" in props ? props.children(props.child) : props.children, "Slottable");
...
var Arrow = React10.forwardRef(
  __name9(function Arrow2(props, forwardedRef) {
...
var Popper = __name11((props) => {
  const { __scopePopper, children } = props;
  const [anchor, setAnchor] = React12.useState(null);
  const [placementState, setPlacementState] = React12.useState(void 0);
...
var PopperAnchor = React12.forwardRef(
  __name11(function PopperAnchor2(props, forwardedRef) {
    const { __scopePopper, virtualRef, ...anchorProps } = props;
    const context = usePopperContext(ANCHOR_NAME, __scopePopper);
    const ref = React12.useRef(null);
    const onAnchorChange = context.onAnchorChange;
    const callbackRef = React12.useCallback(
      (node) => {
        ref.current = node;
        if (node) {
          onAnchorChange(node);
...
var PopperContent = React12.forwardRef(
  __name11(function PopperContent2(props, forwardedRef) {
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      whileElementsMounted: __name11((...args) => {
      ...
      middleware: [
        ...
        size3({
          ...detectOverflowOptions,
          apply: __name11(({ elements, rects, availableWidth, availableHeight }) => {
...
var PopperArrow = React12.forwardRef(
  __name11(function PopperArrow2(props, forwardedRef) {
...
__name11(isNotNull, "isNotNull");
var transformOrigin = __name11((options) => ({
...
__name11(getSideAndAlignFromPlacement, "getSideAndAlignFromPlacement");
var Root2 = Popper;
...
var Portal = React13.forwardRef(
  __name12(function Portal2(props, forwardedRef) {
    var _a;
...
var VisuallyHidden = React17.forwardRef(
  __name16(function VisuallyHidden2(props, forwardedRef) {
...
var TooltipProvider = __name17((props) => {
  const {
    __scopeTooltip,
...
var TooltipTrigger = React18.forwardRef(
  __name17(function TooltipTrigger2(props, forwardedRef) {
...
var TooltipPortal = __name17((props) => {
...
var TooltipContent = React18.forwardRef(
  __name17(function TooltipContent2(props, forwardedRef) {
...
var TooltipContentHoverable = React18.forwardRef(__name17(function TooltipContentHoverable2(props, forwardedRef) {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
...
var TooltipContentImpl = React18.forwardRef(
  // blank line to reduce diff noise
  __name17(function TooltipContentImpl2(props, forwardedRef) {
    const {
      __scopeTooltip,
      children,
...
var TooltipArrow = React18.forwardRef(
  __name17(function TooltipArrow2(props, forwardedRef) {
